...
const textMap = {
    ...
    "o'quvchilarni boshqaradi — barchasi bitta tizimda.": "students — all in one system.",
    ...
    "drag": "drag",
    "qiling — globeni aylantiring.": "— rotate the globe.",
    "Scroll — zoom.": "Scroll — zoom.",

    // === TRACKS SECTION ===
    "Qaysi yo'nalish sizga mosligini tanlang — portal sizni kerakli": "Choose the direction that suits you — the portal connects you to",
    "kurslarga ulaydi.": "courses.",
    "Zero → Hero Frontend": "Zero → Hero Frontend",
    ...
    "9–14 yosh uchun maxsus dastur": "Special program for ages 9–14",
    ...
    "Boshlang'ich → Junior": "Beginner → Junior",
    ...
    "Amaliyot": "Practice",
    "Testlar": "Tests",
    "Bolalar uchun IT (9–14 yosh)": "IT for Kids (9–14 years)",
    ...
    "Har bir mentor — real tajriba va amaliy ko'nikmalar. 9 ta mentor": "Each mentor has real experience. 9 mentors",
    "Har bir mentor — real tajriba va amaliy koʻnikmalar. 9 ta mentor": "Each mentor has real experience. 9 mentors",
    "rotatsiya animatsiyasi bilan.": "with rotation animation.",
    "Professionallar jamoasi — ularga ishoningiz mumkin.": "Team of professionals you can trust.",
    "Profil": "Profile",
    "review": "reviews",
    "Oldingi": "Previous",
    "Keyingi": "Next",
    ...
    // === PROCESS SECTION ===
    "O'qish jarayoni qanday?": "How does learning work?",
    "Oʻqish jarayoni qanday?": "How does learning work?",
    "Oddiy": "Not just",
    "emas — real loyiha, mentor nazorati va portfelga": "— real projects, mentor supervision and",
    "tayyor yo'l xaritasi.": "a ready roadmap for portfolio.",
    "tayyor yoʻl xaritasi.": "a ready roadmap for portfolio.",
    ...
    "Portal orqali toʻliq roʻyxatdan oʻtishga ulgurmasangiz, qisqa": "If you don't have time for full registration,",
    "arizani to'ldiring — menejerlar SMS va qo'ng'iroq orqali": "fill short application — managers will contact via",
    "arizani toʻldiring — menejerlar SMS va qoʻngʻiroq orqali": "fill short application — managers will contact via",
    "bog'lanadi.": "SMS and phone.",
    "bogʻlanadi.": "SMS and phone.",
    "Formani to'ldiring — biz sizga mos kurs va jadval tavsiya qilamiz.": "Fill the form — we'll recommend suitable course.",
    "Birinchi tanishuv darsi — bepul": "First introductory lesson — free",
    ...
    "Ariza yuborildi ✅ Menejer SMS/qo'ng'iroq orqali bog'lanadi.": "Application submitted ✅ Manager will contact via SMS/call.",

    // === RESULTS SECTION ===
    "Bitiruvchilar natijalari": "Graduate Results",
    "Real portfel, real ish, real ko'nikma. Natijalar — bizning": "Real portfolio, real job, real skills. Results — our",
    "standart.": "standard.",
    ...
    "— Ota-ona fikri": "— Parent's opinion",

    // === FAQ SECTION ===
    "Ko'p beriladigan savollar": "Frequently Asked Questions",
    "Koʻp beriladigan savollar": "Frequently Asked Questions",
    "Eng ko'p so'raladigan savollar — bir joyda.": "Most asked questions — in one place.",
    "Eng koʻp soʻraladigan savollar — bir joyda.": "Most asked questions — in one place.",
    "Savollaringizga javoblar.": "Answers to your questions.",
    "Ro'yxatdan o'tish qanday tasdiqlanadi?": "How is registration confirmed?",
    "Roʻyxatdan oʻtish qanday tasdiqlanadi?": "How is registration confirmed?",
    ...
    "Admin panelga kirish faqat \"Kirish\" oynasi orqali — maxsus": "Admin access only through 'Login' — with special",
    ...
    "Ha, 9–14 yosh uchun Kids IT dasturi mavjud.": "Yes, Kids IT program for ages 9–14.",
    ...
    "09:00 – 20:00 (Dushanba – Shanba)": "09:00 – 20:00 (Mon – Sat)",
    "10:00 – 19:00 (Dushanba – Juma)": "10:00 – 19:00 (Mon – Fri)",
    "09:00 – 18:00 (Dushanba – Shanba)": "09:00 – 18:00 (Mon – Sat)",
    "Qo'ng'iroq": "Call",
    "Xaritada": "On Map",
    ...
    // === FOOTER ===
    "IT Center — zamonaviy kasblar uchun zamonaviy ta'lim. Biz bilan IT olamiga qadam qo'ying.": "IT Center — modern education for modern careers.",
    ...
    "© 2024 IT Center. Barcha huquqlar himoyalangan.": "© 2024 IT Center. All rights reserved.",
    ...
    "2 ta savol — mos kursni tavsiya qilamiz.": "2 questions — we'll recommend the right course.",
    "Daraja": "Level",
    "Noldan": "From zero",
    "Maqsad": "Goal",
    "Boshlash": "Start",
    ...
    "Parolni qayta kiriting": "Re-enter password",
    "Shahar / tuman": "City / district",
    "© 2025 IT Center": "© 2025 IT Center",

    // === BRANCH INFO ===
    "Dushanba – Shanba": "Mon – Sat",
    "Dushanba – Juma": "Mon – Fri",
        ...
        if (lang === "EN") {
            ...
            function normalizeApostrophes(text) {
                return text
                    ...
                    .replace(/ʻ/g, "'")  // Modifier letter turned comma (backup)
                    .replace(/ʼ/g, "'"); // Modifier letter apostrophe (backup)
            }
            ...
            // Translate title
            document.title = "IT Center Portal — Student and Admin";
            ...
            document.title = "IT Center Portal — Talaba va Admin";
        }
...
function loadCustomTranslations() {
    try {
        ...
        if (count > 0) {
            ...
            console.log(`✅ Loaded ${count} custom translations from localStorage`);
        }
    } catch (e) {
...
window.addEventListener("storage", (event) => {
    if (event.key === "itc_custom_translations" || event.key === "itc_translations_updated") {
        console.log("📡 Translation update detected from admin panel");
        refreshTranslations();
    }
});
